...
// js has alot of features but few we use in js are not part of js but of browser but still we are to use them because js interact with window to use them 
